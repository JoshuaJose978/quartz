---
title: Optimizing RAG with the Smarter Indexing RAPTOR Pipeline - Probabilistic Clustering, UMAP, Tree Structure and more
---

There are [tons of RAG optimization techniques](https://levelup.gitconnected.com/testing-18-rag-techniques-to-find-the-best-094d166af27f) you can use to improve performance, from query transformations to re-ranking models. The challenge is that each new layer often brings extra complexity, more LLM calls, and more moving parts to your architecture.


<h3>But what if we could get a better performance by focusing on just one thing, building a smarter index?</h3>
...
https://github.com/FareedKhan-dev/rag-with-raptor?source=post_page-----65bb946526ad---------------------------------------
...
- [Initializing our RAG Configuration](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#a874)
- [Data Ingestion and Preparation](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#e861)
- [Creating Leaf Nodes of RAPTOR Tree](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#4403)
- [Implementing Simple RAG and Its Problems](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#eaf6)
- [Building a Hierarchical Clustering Engine](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#87d5)
- [Dimensionality Reduction with UMAP](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#be1a)
- [Optimal Cluster Number Detection](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#ab53)
- [Probabilistic Clustering with GMM](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#6896)
- [Hierarchical Clustering Orchestrator](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#b10a)
- [Building and Executing the RAPTOR Tree](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#eb08)
- [Indexing with the Collapsed Tree Strategy](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#3a56)
- [Quantitative Evaluation of RAPTOR against Simple RAG](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#3de3)
- [Qualitative Evaluation using LLM as a Judge](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#7b6b)
- [Summarizing the RAPTOR Approach](https://levelup.gitconnected.com/optimizing-rag-with-the-smarter-indexing-raptor-pipeline-65bb946526ad#259e)
...
![[Pasted image 20250905092031.png]]
...
![[Pasted image 20250905092125.png]]
...
# - token_counts: The list of token counts for each document.  
# - bins=50: Divides the data into 50 intervals (bars).  
...
![[Pasted image 20250905092503.png]]
...
![[Pasted image 20250905092601.png]]
...
![[Pasted image 20250905092625.png]]
...
![[Pasted image 20250905092806.png]]
...
![](https://miro.medium.com/v2/resize:fit:2000/1*Mrtf9B2T-nTGTB6AVj0LJg.png)
...
![](https://miro.medium.com/v2/resize:fit:2000/1*6vzE0gtMB2gKBa-SgkqUPw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*fcK8rc48yOx_tG6QTrdiYg.png)
...
![](https://miro.medium.com/v2/resize:fit:2000/1*8XuUoGkiD6uRNCSjJDw7pA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*jyPBmUYysnSBkgdO0Zdpiw.png)
...
![](https://miro.medium.com/v2/resize:fit:2000/1*YrNiQmXdHv3sMlB8pvfd1g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*VJZ3N3L39wLlQRVqZrgX3A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*WnzBAGHlRw3gNTvWQJo9gQ.png)
...
def perform_clustering(embeddings: np.ndarray, dim: int = 10, threshold: float = 0.1) -> List[np.ndarray]:  
    ...
    for i in range(n_global_clusters):  
        ...
        # Increment the total cluster count to ensure the next global cluster's local IDs are unique.  
...
![](https://miro.medium.com/v2/resize:fit:2000/1*glBve60XyvrdPhSc_t47Gw.png)
...
def recursive_build_tree(texts: List[str], level: int = 1, n_levels: int = 3) -> Dict[int, Tuple[pd.DataFrame, pd.DataFrame]]:  
    ...
    # Since a text can belong to multiple clusters, we need to 'explode' the DataFrame.  
    expanded_list = []  
...
![](https://miro.medium.com/v2/resize:fit:2000/1*9a82S8RZ5Hhp8gWKQiJK4w.png)
...
![](https://miro.medium.com/v2/resize:fit:2000/1*K-l_RylqmHvm--7uEyNiig.png)
...
4.  Read the user question and both answers carefully.  
5.  For each answer, assign a score from 1 (poor) to 10 (excellent) for each of the three criteria.  
6.  Based on the scores, determine which answer is better.  
7.  Provide a brief but clear justification for your choice.  
8.  Output your final verdict as a single, valid JSON object.  
...
# Generate answers from both systems for the judge's question  
